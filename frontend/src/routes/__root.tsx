...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Analyze SQL queries, detect anti-patterns, and get index recommendations." },
      { name: "author", content: "QueryMind" },
      { property: "og:title", content: "QueryMind — Database Query Optimizer" },
      { property: "og:description", content: "Analyze SQL queries, detect anti-patterns, and get index recommendations." },
